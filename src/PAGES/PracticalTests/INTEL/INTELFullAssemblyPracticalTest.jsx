...
export default function INTELFullAssemblyPracticalTest({ onFinish, onBack, onLogout }) {
  ...
  useEffect(() => {
    const unsub = onAuthStateChanged(auth, async (currentUser) => {
      ...
      try {
        ...
        console.error("Error fetching INTEL Assembly Practical Test profile:", error);
      }
    });
    return () => unsub();
  }, []);
