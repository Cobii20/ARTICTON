...
const STEP_INSTRUCTION_GUIDES = Object.freeze({
  ...
  cpu: {
    ...
    procedure: [
      ...
      "Raise the socket retention arm fully. Use the corner triangle and socket orientation as references before lifting the processor straight up by its edges.",
      "Place the CPU on an antistatic surface or in a protective tray; keep the contact side and pins clear of the table."
    ],
    safety: "Never pull an AMD cooler straight up while the paste is still bonded; doing so can pull a pin-grid CPU from the socket. Do not touch or bend CPU pins.",
    verify: "The cooler is free, the retention mechanism is fully open, and the CPU lifts vertically without friction.",
    avoid: "Forcing the retention arm, twisting the CPU in the socket, or resting the pins on the work surface.",
              ...
              <div className="flex w-full flex-wrap items-center justify-between gap-4 rounded-[22px] border border-[#1a2438] bg-[#0b1220]/86 px-6 py-4 shadow-[0_18px_60px_rgba(0,0,0,0.30)] backdrop-blur-xl">
                <div className="flex flex-wrap items-center justify-end gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-[11px] uppercase tracking-[0.24em] text-[#FFD41C]">AMD Disassembly View</div>
                  </div>
                </div>
